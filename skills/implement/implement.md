...
- No memory backend → Skip memory search. Rely on codebase scanning only. Save plan to .xgh/docs/ only.
...
Save plan to: `.xgh/docs/plans/YYYY-MM-DD-[ticket-id]-plan.md`
