...
usage: "/xgh-watch-prs <start|poll-once> <PR> [<PR>...] [--repo owner/repo] [--interval 3m] [--merge-method squash] [--post-merge-hook '<cmd>'] | /xgh-watch-prs <status|stop> [--repo owner/repo]"
---
