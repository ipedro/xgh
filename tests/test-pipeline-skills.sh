...
assert_contains "skills/track/track.md"       "xgh:ingest-track"
assert_contains "skills/track/track.md"       "initial backfill"
assert_contains "skills/track/track.md"       "ingest.yaml"
assert_contains "skills/doctor/doctor.md"     "xgh:ingest-doctor"
assert_contains "skills/doctor/doctor.md"     "launchctl"
